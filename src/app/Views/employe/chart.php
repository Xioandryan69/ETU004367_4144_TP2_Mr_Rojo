    ...
    <div class="app-wrap">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-nav">
                <li><a href="<?= site_url('employe/dashboard') ?>" class="active"><i class="bi bi-grid-1x2"></i> Tableau
                        de bord</a></li>
                <li><a href="<?= site_url('employe/nouveau-conge') ?>"><i class="bi bi-plus-circle"></i> Nouvelle
                        demande</a></li>
                <li><a href="<?= site_url('employe/mes-conges') ?>"><i class="bi bi-calendar3"></i> Mes demandes</a>
                </li>
        ...
        <div class="main">
            <div class="topbar">
                ...
                <div class="topbar-actions">
                    <a href="<?= site_url('logout') ?>" class="icon-btn" title="Déconnexion"><i
