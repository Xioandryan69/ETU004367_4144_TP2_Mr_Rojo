...
.f-input,.f-textarea{width:100%;border:1.5px solid var(--border);border-radius:8px;padding:10px 12px;font-size:.875rem;font-family:'DM Sans',sans-serif;background:var(--white);color:var(--ink)}
...
<div class="app-wrap">
  ...
  <div class="main">
    <div class="topbar"><div class="topbar-title">Départements</div></div>
    <div class="content">
      ...
      <div class="form-section">
        ...
        <form action="<?= site_url('admin/departements') ?>" method="post">
          <?= csrf_field() ?>
          ...
          <div class="f-group" style="margin-bottom:1rem">
            ...
            <textarea name="description" class="f-textarea"><?= esc(old('description')) ?></textarea>
          </div>
          ...
          <tbody>
            <?php foreach ($departements as $departement): ?>
              <tr>
                ...
                <td>
                  <form action="<?= site_url('admin/departements/delete/'.(int)$departement['id']) ?>" method="post" style="margin:0">
                    <?= csrf_field() ?>
                    <button class="btn-sm btn-del" type="submit" onclick="return confirm('Supprimer ce département ?')"><i class="bi bi-trash"></i> Supprimer</button>
                  </form>
                </td>
              </tr>
            <?php endforeach; ?>
            <?php if (empty($departements)): ?>
              <tr><td colspan="3" style="text-align:center;color:var(--muted);padding:1.5rem">Aucun département.</td></tr>
            <?php endif; ?>
          </tbody>
        </table>
      </div>
